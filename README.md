...
<h3>Un mod développé sur <a href="https://www.baldursgateworld.fr">La Couronne de Cuivre</a> pour Baldur's Gate II : Enhanced Edition et EET<h3>
...
[Read the mod's readme](https://gwendolynefreddy.github.io/docs/lcc/mymod/readme/readme-lcc-fr.html) //TODO

[Download the mod at La Couronne de Cuivre]()<br> //TODO
...
En effet, le patch 2.6 de Baldur's Gate II : Enhanced Edition propose une toute nouvelle traduction française officielle, par le prestataire de Beamdog : Mogi Group.
Malheureusement, certaines modifications arbitraires des textes originaux de la traduction française, comme les vouvoiements/tutoiements, par exemple Imoen qui vouvoie le personnage joueur, ou encore des changements de noms propres, par exemple « Spellhold » qui devient « Brisesort » ne sont pas compatibles avec le travail de traduction effectué par les traducteurs francophones bénévoles depuis maintenant plus de 20 ans.
De plus, de nombreuses corrections supplémentaires ont été intégrées à cette traduction, voir la section <a href="#compon">Composants</a> pour plus de détails. Merci de nous signaler toute éventuelle faute sur le <a href="https://www.baldursgateworld.fr">Forum du mod</a>.
...
Le mod « Correction de la traduction de Baldur's Gate II : Enhanced Edition » est conçu pour fonctionner sur Baldur's Gate II : Enhanced Edition (BG2:EE) et Enhanced Edition Trilogy (EET).
...
- Correction et harmonisation des noms propres (personnage, lieu, organisation, etc.).
- Correction des non-sens et erreurs de traduction.
- Harmonisation du cartouche des objets.
- Harmonisation de la ponctuation («», ', -, etc.).
- Correction des caractères spéciaux (œ, û, ï, ë, Œ, Ê, É, È, À, Ç, etc.).
- Supression des espaces insécables et whitespaces.
- Correction des fautes d'othographe, de conjugaison et grammaire.
...
###### « Correction de la traduction de Baldur's Gate II : Enhanced Edition » n'est pas développé, supporté ni approuvé par BioWare&trade; ou Interplay/Black Isle, Overhaul, Beamdog ou Wizards of the Coast. Il a été développé par AUTEUR, et est basé sur le jeu Baldur's Gate II et son extension.
...
#### Version 01 &nbsp;(01 juillet 2021)

&#9755; <ins>Modifications générales :</ins>
  - Création du dossier :file_folder: correctfrBG2EE.
  - blabla :
    - blabla1.
    - blabla2.
